...
#SBATCH --mail-user=ispe1418@colorado.edu # Where to send maili
#SBATCH --nodes=1 # Run on a single node
#SBATCH --ntasks=64
#SBATCH --partition long
#SBATCH --mem=500gb # Memory limit
#SBATCH --time=100:00:00 # Time limit hrs:min:sec
#SBATCH --output=/scratch/Users/ispe1418/AREA/eando/area_test_ptsd.%j.out # Standard output
#SBATCH --error=/scratch/Users/ispe1418/AREA/eando/area_test_ptsd.%j.err # Standard error log
...
indir=/Shares/down/public/forAREA/ptsd/
commoncolumn=Run
rank_file=${indir}geneexptpm.rank.csv
boolean_attribute_file=${indir}ptsd.boolean.csv
