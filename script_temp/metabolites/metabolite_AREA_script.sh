...
indir=/Shares/down/public/INLCUDE_2024/kallisto_20241030/output-files/
commoncolumn="ParticipantID"
rank_file=${indir}metabolomics_values.csv
boolean_attribute_file=${indir}metabolomics_binary.csv
